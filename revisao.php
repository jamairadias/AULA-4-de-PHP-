...
<body>
    ...
    <main class="container">
        ...
        <section id="estruturas-de-repeticao">
            ...
            ?>
            <p>Resposta: <br>
                <?php echo  fullName('Sara', 'Souza'); ?>
            </p>
            <?php
                function entre100($numero){
            
                    if (($numero>0 && $numero<=100) == true){
                        return ("Numero está entre 0 e 100");
           }  else {
                        return ("Número fora do intervalo entre 0 e 100");
                    } 
